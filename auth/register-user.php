    ...
    if (!validateCSRFToken($_POST['csrf_token'] ?? '')) {
        ...
        try {
            ...
            if ($stmt->fetch()) {
                ...
                header('Location: /IST-PHP-PROJECTS/PHP-BLOG-APP/users/dashboard.php');
                exit();
            }
...
<head>
    ...
    <title>eBlog - Register as User</title>
...
<body>
    <div class="auth-container">
            <div class="auth-form">
                ...
                <p class="auth-link">
                    Want to register as admin? <a href="register-admin.php">Admin Registration</a>
                </p>
            </div>
    </div>
</body>
